		...
		opts = {
			...
			filetypes = {
				markdown = {
					...
					template = [[<div align=center> <img src="$FILE_PATH" width = 80%/> </div>
<center>$FILE_NAME_NO_EXT</center>
$CURSOR]],
					download_images = false,
				},
				tex = {
					url_encode_path = true,
					template = [[\includegraphics[width=0.8\textwidth]{$FILE_PATH}
\caption{$FILE_NAME_NO_EXT}
$CURSOR]],
				},
			},
		},
