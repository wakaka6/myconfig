...
local function openTerminal()
	hs.execute(
		"/usr/bin/open -na /Applications/kitty.app || /usr/bin/open -na /Applications/Ghostty.app || /usr/bin/open -na /Applications/Alacritty.app || /usr/bin/open -na /Applications/iTerm.app || /usr/bin/open -na /Applications/Utilities/Terminal.app",
		true
	)
end
